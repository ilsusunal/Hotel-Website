...
export default function HotelLocation() {
  return (
    <div className='flex flex-col gap-12 my-4 md:my-20 p-8'>
      <section className='md:flex md:gap-24 justify-center'>
        <img src={HotelMap} alt="Map" className='md:w-2/3 rounded-2xl'/>
